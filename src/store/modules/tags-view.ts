...
class TagsView extends VuexModule implements ITagsViewState {
	public fixedTag = [{ path: '/home', title: '首页', fullPath: '/home' }]
	public visitedViews: ITagView[] = this.fixedTag
	...
	private DEL_OTHERS_VISITED_VIEWS (view: ITagView) {
		...
		this.visitedViews.unshift({ path: '/home', title: '首页', fullPath: '/home' })
	}
	...
	private DEL_ALL_VISITED_VIEWS () {
		// 保留标签
		this.visitedViews = [{ path: '/home', title: '首页', fullPath: '/home' }]
	}
